...
export default {
  ...
  // cacheDirectory: "/private/var/folders/zx/mn2mx4tx0cd_p6p_3hckfhzw0000gn/T/jest_dx",
  ...
  // Indicates whether each individual test should be reported during the run
	// Untuk menampilkan detail dari test nya, default nya false/undefined, dmna jest tidak akan menampilkan detail testnya
  verbose: true,
